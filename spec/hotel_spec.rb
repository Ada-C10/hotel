...
describe "Hotel Class: Wave One: Tracking Reservations" do
  ...
  describe "reserve_room" do
    before do
      @hotel = Hotel.new(20)
      @hotel.reserve_room(Reservation.new('2018-02-03', '2018-02-05', 1))
    end
    ...
    it "the reservation and room are connected" do
      expect(@hotel.reservations[0].rooms[0]).must_be_same_as @hotel.rooms[0]
    end

    it "can book multiple rooms" do
      @hotel.reserve_room(Reservation.new('2018-02-03', '2018-02-09', 2))
      expect(@hotel.reservations[1].rooms.length).must_equal 2
    end

    it "raises an error for unavailable dates" do
      @hotel.reserve_room(Reservation.new('2018-03-01', '2018-03-15', 20))

      #same dates
      expect{@hotel.reserve_room(Reservation.new('2018-03-01', '2018-03-15', 1))}.must_raise ArgumentError
      #overlaps in the front
      expect{@hotel.reserve_room(Reservation.new('2018-02-28', '2018-03-15', 1))}.must_raise ArgumentError
      #overlaps in the back
      expect{@hotel.reserve_room(Reservation.new('2018-03-01', '2018-03-18', 1))}.must_raise ArgumentError
      #completely contained
      expect{@hotel.reserve_room(Reservation.new('2018-03-05', '2018-03-13', 1))}.must_raise ArgumentError
      #completely containing
      expect{@hotel.reserve_room(Reservation.new('2018-02-28', '2018-03-16', 1))}.must_raise ArgumentError
    end

    it "does not raise an error for date ranges that are not overlapping " do
      @hotel.reserve_room(Reservation.new('2018-04-01', '2018-04-15', 20))

      #completely before
      expect(@hotel.reserve_room(Reservation.new('2018-03-01', '2018-03-15', 1)))
      #completely after
      expect(@hotel.reserve_room(Reservation.new('2018-04-16', '2018-04-18', 1)))
      #ends on the checkin date
      expect(@hotel.reserve_room(Reservation.new('2018-03-20', '2018-04-01', 1)))
      #starts on the checkout date
      expect(@hotel.reserve_room(Reservation.new('2018-04-15', '2018-04-18', 1)))
    end

    it "reservation can start on the same day that another reservation for the same room ends" do
      @hotel.reserve_room(Reservation.new('2018-03-01', '2018-03-15', 20))
      expect{@hotel.reserve_room(Reservation.new('2018-03-15', '2018-03-20', 1))}.must_be_silent
    end
  ...
  describe "list_reservations" do
    before do
      @hotel = Hotel.new(20)
      @hotel.reserve_room(Reservation.new('2018-02-03', '2018-02-05', 1))
      @hotel.reserve_room(Reservation.new('2018-02-03', '2018-02-09', 1))
    end
...
describe "Hotel Class: Wave Two: Room Availability" do
  ...
  describe "list_available_rooms" do
    ...
    it "warns user that all rooms that date are reserved" do
      @hotel.reserve_room(Reservation.new('2018-04-03', '2018-04-05', 20))
...
describe "Hotel Class: Wave Three: Blocks of Rooms" do
  ...
  describe "create_room_block" do
    before do
      @hotel = Hotel.new(20)
      @hotel.create_room_block(BlockRooms.new('2018-01-03', '2018-01-05', 5, 150))
    ...
    it "can create a block of rooms" do
      ...
      expect(@hotel.room_blocks[0].rooms_blocked[0]).must_equal 1
    end
    ...
    it "a block can contain a maximum of 5 rooms" do
      ...
      expect{@hotel.create_room_block(BlockRooms.new('2018-09-05', '2018-09-10', 7, 150))}.must_raise ArgumentError
    end
    ...
    it "if a room is set aside in a block, it is not available for reservation" do
      4.times do
        @hotel.create_room_block(BlockRooms.new('2018-05-03', '2018-05-08', 5, 150))
      end

      expect{@hotel.reserve_room(Reservation.new('2018-05-03', '2018-05-10', 1))}.must_raise ArgumentError
    end
    ...
    it "if a room is set aside in a block it can't be included in another block" do
      ...
      expect{@hotel.create_room_block(BlockRooms.new('2018-05-05', '2018-05-08', 7, 150))}.must_raise ArgumentError
    end

    it "will give the block rooms a discounted rate" do
      @hotel.reserve_block_room(@id, 1)
      @hotel.reserve_room(Reservation.new('2018-01-03', '2018-01-05', 1))
