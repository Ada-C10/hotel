...
describe "ReservationMgr Test" do
  ...
  describe "make_reservation method" do
    ...
    it "returns and argument error if there are no rooms available" do
      ...
      @new_ResMgr.make_reservation(Date.parse("2018-09-05"),Date.parse("2018-09-07"))
      @new_ResMgr.make_reservation(Date.parse("2018-09-05"),Date.parse("2018-09-07"))
      expect{@new_ResMgr.make_reservation(Date.parse("2018-09-05"),Date.parse("2018-09-07"))}.must_raise ArgumentError
    end
    it "will create two new reservations if someone wants two rooms" do
      @new_ResMgr.make_reservation(Date.parse("2018-09-05"),Date.parse("2018-09-07"),rooms: 2)
    ...
    it "will add two instances of res to one room if they are not on the same date" do
      ...
      @new_ResMgr.make_reservation(Date.parse("2018-09-07"),Date.parse("2018-09-09"))
  ...
  describe "reservations_by_date method" do
    ...
    it "creates an array of all the reservations for a particular day" do
      expect(@new_ResMgr.reservations_by_date(Date.parse("2018-09-05"))).must_be_kind_of Array
      expect(@new_ResMgr.reservations_by_date(Date.parse("2018-09-05"))[0]).must_be_kind_of Reservation
      expect(@new_ResMgr.reservations_by_date(Date.parse("2018-09-05")).length).must_equal 3
    end
  end
  ...
  describe "reservation_cost method" do
    before do
      @new_ResMgr = ReservationMgr.new(3)
      @new_ResMgr.make_reservation(Date.parse("2018-09-05"),Date.parse("2018-09-07"))
      @new_ResMgr.make_reservation(Date.parse("2018-09-05"),Date.parse("2018-09-10"))
      @new_ResMgr.make_reservation(Date.parse("2018-09-30"),Date.parse("2018-10-07"))
    end
  ...
  describe "available_rooms method" do
    ...
    it "returns array of available rooms" do
      expect(@new_ResMgr.available_rooms(Date.parse("2018-09-05"),Date.parse("2018-09-07"))).must_be_kind_of Array
      expect(@new_ResMgr.available_rooms(Date.parse("2018-09-05"),Date.parse("2018-09-07")).length).must_equal 1
      expect(@new_ResMgr.available_rooms(Date.parse("2018-11-05"),Date.parse("2018-11-07")).length).must_equal 3
    end
    it "will raise an argument error if check_in date is greater than check_out date" do
      expect{@new_ResMgr.available_rooms(Date.parse("2018-09-07"),Date.parse("2018-09-05"),1)}.must_raise ArgumentError
    end
    it "will raise an argument error if rooms requested is greater than rooms available" do
      expect{@new_ResMgr.available_rooms(Date.parse("2018-09-07"),Date.parse("2018-09-05"),2)}.must_raise ArgumentError
    end
  end
