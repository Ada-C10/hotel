...
describe "ReservationManager" do
  ...
  describe "Wave 2 - Return list of available rooms for given date range" do
    ...
    # binding.pry
      expect(@hotel_ada.available_rooms('2018-08-23', '2018-08-25').length).must_equal 19
      expect(@hotel_ada.available_rooms('2018-08-23', '2018-08-25')[0]).must_be_kind_of Hotel::Room
