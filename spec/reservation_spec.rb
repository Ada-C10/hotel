...
describe "Reservation" do
  let (:reservation) {
    Hotel::Reservation.new({guest_id: "SoccerMom2010@gmail.com", room: 1, date_range: (Date.new(2018,10,20)...Date.new(2018,10,22))})
  }
  let (:reservation2) {
    Hotel::Reservation.new({guest_id: "Guccifer2.0@ada.com", room: 1, date_range: (Date.new(2018,12,02)...Date.new(2018,12,07))})
  }
  let (:reservation3) {
    Hotel::Reservation.new({guest_id: "Jfahmy07@gmail.com", room: 2, date_range: (Date.new(2018,12,03)...Date.new(2018,12,06))})
  }
  let (:reservation4) {
    Hotel::Reservation.new({guest_id: "JimmyCricket@gmail.com", room: 5, status: :block_reserved, date_range: (Date.new(2018,12,03)...Date.new(2018,12,06))})
  }
