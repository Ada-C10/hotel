...
describe 'Reservation' do
  ...
  it 'raises an error if end date is before start date' do
    expect {
      rs4 = Hotel::Reservation.new(104, "Dolly Raj", [4, 7, 8], "May 12, 2019", "May 10, 2019", 600.00 )
    }.must_raise ArgumentError
  end

  it 'raises an error if start or end data are nil' do
    expect {
      rs5 = Hotel::Reservation.new(104, "Dolly Raj", [4, 7, 8], nil, "May 10, 2019", 600.00 )
    }.must_raise ArgumentError
  end

  it 'raises an error if start or end data are not dates' do
    expect {
      rs6 = Hotel::Reservation.new(104, "Dolly Raj", [4, 7, 8], "keyboard", "test", 600.00 )
    }.must_raise ArgumentError
  end

  it 'raises an error if no rooms are included in the booking' do
    expect {
      rs7 = Hotel::Reservation.new(104, "Dolly Raj", [], "May 12, 2019", "May 14, 2019", 600.00 )
    }.must_raise ArgumentError
  end

  it 'raises an error if no guest name is included in the booking' do
    expect {
      rs8 = Hotel::Reservation.new(104, "", [8], "May 12, 2019", "May 14, 2019", 600.00 )
    }.must_raise ArgumentError
    expect {
      rs9 = Hotel::Reservation.new(104, nil, [8], "May 12, 2019", "May 14, 2019", 600.00 )
    }.must_raise ArgumentError
  end
