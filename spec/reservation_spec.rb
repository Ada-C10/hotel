...
describe "Reservation" do
  describe "initialize" do
    ...
    it "Create an instance of reservation" do
      reservation = Reservation.new(7, 4, "4-17-2018", "4-20-2018")
    ...
    it "keeps track of ID" do
      id = 7
      reservation = Reservation.new(id, 4, "4-17-2018", "4-20-2018")
    ...
    it "keeps track of room number" do
      room = 4
      reservation = Reservation.new(7, room, "4-17-2018", "4-20-2018")
