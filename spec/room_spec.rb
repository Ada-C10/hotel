...
describe "Room class" do
  before do
    ...
    @new_room = Room.find_available_room(@array_of_used_rooms)
  end

    describe "listing room numbers" do
      it "can list all of the rooms in the hotel" do
        expect (Room::ROOMS).must_be_kind_of Array
        expect (Room::ROOMS.length).must_equal 20
      end
    end
    ...
    describe "assigning room numbers" do
      ...
      it "can assign a block of room numbers" do
        new_block = Room.find_block_of_rooms(5, @array_of_used_rooms)
